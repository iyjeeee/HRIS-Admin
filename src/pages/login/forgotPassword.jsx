// forgotPassword.jsx — Admin Forgot Password: consistent branding with login (text-only, no icon)
...
const ForgotPassword = () => {
  ...
  // Switch to success screen on valid submit
    ...
    <div className="flex min-h-screen w-full font-sans">
      ...
      <div className="w-full lg:w-1/2 bg-white flex flex-col justify-center items-center p-8 relative">
        <div className="w-full max-w-md">
          ...
          {/* Back button — only in form state */}
          {!isSuccess && (
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type={showPasswords?'text':'password'} value={newPassword}
                      ...
                      className={`w-full pl-10 pr-10 py-2.5 border rounded-lg focus:outline-none focus:ring-1 text-sm transition-colors ${errors.newPassword?'border-red-500 focus:border-red-500 focus:ring-red-500 bg-red-50':'border-gray-300 focus:border-yellow-500 focus:ring-yellow-500'}`}
                    />
                    {/* Toggle both password fields */}
                    <button type="button" onClick={()=>setShowPasswords(!showPasswords)} className="absolute right-3 top-3 text-gray-400 hover:text-gray-600 cursor-pointer">
                      {showPasswords
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type={showPasswords?'text':'password'} value={confirmPassword}
                      ...
                      className={`w-full pl-10 pr-4 py-2.5 border rounded-lg focus:outline-none focus:ring-1 text-sm transition-colors ${errors.confirmPassword?'border-red-500 focus:border-red-500 focus:ring-red-500 bg-red-50':'border-gray-300 focus:border-yellow-500 focus:ring-yellow-500'}`}
                    />
                  </div>
